...
RADIANS: typeof P5.RADIANS;
   ...
   * @param properties An object containing key-value pairs to set.
   * @returns The current spline properties.
   */
  splineProperties(properties: object): object;
   ...
   */
  uniformFloat(name: string, defaultValue?: any): any;

  /**
   * Create a Vec2 uniform variable
   */
  uniformVec2(name: string, defaultValue?: any): any;

  /**
   * Create a Vector2 uniform variable
   */
  uniformVector2(name: string, defaultValue?: any): any;

  /**
   * Create a Vec3 uniform variable
   */
  uniformVec3(name: string, defaultValue?: any): any;

  /**
   * Create a Vector3 uniform variable
   */
  uniformVector3(name: string, defaultValue?: any): any;

  /**
   * Create a Vec4 uniform variable
   */
  uniformVec4(name: string, defaultValue?: any): any;

  /**
   * Create a Vector4 uniform variable
   */
  uniformVector4(name: string, defaultValue?: any): any;

  /**
   * Create a Int uniform variable
   */
  uniformInt(name: string, defaultValue?: any): any;

  /**
   * Create a IVec2 uniform variable
   */
  uniformIVec2(name: string, defaultValue?: any): any;

  /**
   * Create a IVec3 uniform variable
   */
  uniformIVec3(name: string, defaultValue?: any): any;

  /**
   * Create a IVec4 uniform variable
   */
  uniformIVec4(name: string, defaultValue?: any): any;

  /**
   * Create a Bool uniform variable
   */
  uniformBool(name: string, defaultValue?: any): any;

  /**
   * Create a BVec2 uniform variable
   */
  uniformBVec2(name: string, defaultValue?: any): any;

  /**
   * Create a BVec3 uniform variable
   */
  uniformBVec3(name: string, defaultValue?: any): any;

  /**
   * Create a BVec4 uniform variable
   */
  uniformBVec4(name: string, defaultValue?: any): any;

  /**
   * Create a Mat2x2 uniform variable
   */
  uniformMat2x2(name: string, defaultValue?: any): any;

  /**
   * Create a Mat3x3 uniform variable
   */
  uniformMat3x3(name: string, defaultValue?: any): any;

  /**
   * Create a Mat4x4 uniform variable
   */
  uniformMat4x4(name: string, defaultValue?: any): any;

  /**
   * Create a Sampler2d uniform variable
   */
  uniformSampler2d(name: string, defaultValue?: any): any;
 ...
 * @returns The current spline properties.
 */
function splineProperties(properties: object): object;
 ...
 * Create a Float uniform variable
 */
function uniformFloat(name: string, defaultValue?: any): any;

/**
 * Create a Vec2 uniform variable
 */
function uniformVec2(name: string, defaultValue?: any): any;

/**
 * Create a Vector2 uniform variable
 */
function uniformVector2(name: string, defaultValue?: any): any;

/**
 * Create a Vec3 uniform variable
 */
function uniformVec3(name: string, defaultValue?: any): any;

/**
 * Create a Vector3 uniform variable
 */
function uniformVector3(name: string, defaultValue?: any): any;

/**
 * Create a Vec4 uniform variable
 */
function uniformVec4(name: string, defaultValue?: any): any;

/**
 * Create a Vector4 uniform variable
 */
function uniformVector4(name: string, defaultValue?: any): any;

/**
 * Create a Int uniform variable
 */
function uniformInt(name: string, defaultValue?: any): any;

/**
 * Create a IVec2 uniform variable
 */
function uniformIVec2(name: string, defaultValue?: any): any;

/**
 * Create a IVec3 uniform variable
 */
function uniformIVec3(name: string, defaultValue?: any): any;

/**
 * Create a IVec4 uniform variable
 */
function uniformIVec4(name: string, defaultValue?: any): any;

/**
 * Create a Bool uniform variable
 */
function uniformBool(name: string, defaultValue?: any): any;

/**
 * Create a BVec2 uniform variable
 */
function uniformBVec2(name: string, defaultValue?: any): any;

/**
 * Create a BVec3 uniform variable
 */
function uniformBVec3(name: string, defaultValue?: any): any;

/**
 * Create a BVec4 uniform variable
 */
function uniformBVec4(name: string, defaultValue?: any): any;

/**
 * Create a Mat2x2 uniform variable
 */
function uniformMat2x2(name: string, defaultValue?: any): any;

/**
 * Create a Mat3x3 uniform variable
 */
function uniformMat3x3(name: string, defaultValue?: any): any;

/**
 * Create a Mat4x4 uniform variable
 */
function uniformMat4x4(name: string, defaultValue?: any): any;

/**
 * Create a Sampler2d uniform variable
 */
function uniformSampler2d(name: string, defaultValue?: any): any;
